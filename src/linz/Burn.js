...
module.exports = class Burnsp {
    ...
    constructor() {
        ...
        this.burnimg = path.join(__dirname, '../../assets/img/burn.png');
    }
    ...
    // helper to load image from various sources
    ...
    async toAttachment() {
        ...
        try {
            ...
            ctx.drawImage(avatarImg, 39, 44, 120, 120);
        } catch (e) {
        ...
        // burn overlay image
        try {
            const b = await this._loadImage(this.burnimg);
